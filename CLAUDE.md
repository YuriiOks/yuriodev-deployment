...
- Dependabot (`.github/dependabot.yml`): weekly npm/pip/docker/github-actions bumps; `vite` and `@vitejs/plugin-react` majors are ignored (move both together by hand).
